...
!function (a) {
    ...
    ace.demo = {
        ...
        function b() {
            ...
            if ("fixed" == b.css("position")) {
                var d = parseInt(a(window).width()), e = d > 320 ? 60 : d > 240 ? 40 : 30, f = parseInt(d) - e,
                    g = parseInt(a(window).height()) - 30, h = parseInt(Math.min(f, 320));
                b.css("width", h);
            ...
            setup: function () {
                ...
                g.on(c, function (c) {
                    ...
                    var i, j = c.originalEvent.touches ? c.originalEvent.touches[0] : c,
                        k = {coords: [j.pageX, j.pageY], origin: a(c.target)}, l = !1, m = 0, n = 0;
    ...
    function c(b, c) {
        ...
        function k(c) {
            ...
            g && (o = n, m.top += o);
            var t = parseInt(m.top + r), v = 0, y = u.height(), z = parseInt(m.top - k - o), A = y, B = q.horizontal,
                C = !1;
        ...
        var y = -1, z = d ? "touchstart.sub_hover" : "mouseenter.sub_hover",
    ...
    var d = function (b, d) {
        ...
        this.reload = function () {
            ...
            var e = this.$box, f = e.find(".widget-body").eq(0), g = null,
                h = a || (e.hasClass("collapsed") ? "show" : "hide"), i = "show" == h ? "shown" : "hidden";
